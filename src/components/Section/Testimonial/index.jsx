  ...
  return (
    <div key={testimony.id} className="p-4 md:w-1/2 w-full">
      <Card shadow={false} className="h-full bg-gray-100 p-8">
        ...
        <p className="leading-relaxed mb-6">{testimony.testimony_quotes}</p>
...
export default function Testimonial() {
  ...
  // console.log(testimonialsData.user);
  ...
  if (errors) {
    return (
      <main className="py-6 px-12 space-y-2 bg-gray-100 min-h-screen w-full flex items-center justify-center">
        <div className="text-2xl font-bold text-gray-500">{errors} ..</div>
      </main>
    );
  }
